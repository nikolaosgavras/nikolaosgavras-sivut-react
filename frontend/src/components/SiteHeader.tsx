    ...
    <nav className="sticky top-0 z-50 border-b border-white/10 bg-slate-800/30 text-white shadow-lg shadow-gray-700/10 backdrop-blur-xl">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex h-20 items-center justify-between">
          ...
          <div className="title">
            <Link to="/" className="font-bold text-white text-xl">Nikolaos Gavras</Link>
          </div>
...
{/*             <NavLink to="/services" className="button hover:bg-gray-800 py-2 px-4 rounded-xl">Palvelut</NavLink> */}
          ...
          <div className="hidden md:flex space-x-3">
            <a href="https://www.linkedin.com/in/nikolaosgavras/" aria-label="My LinkedIn page" target="_blank" rel="noreferrer noopener" className="hover:text-gray-300">
            ...
            <a href="https://github.com/nikolaosgavras" aria-label="My GitHub page" target="_blank" rel="noreferrer noopener" className="hover:text-gray-300">
      ...
      {/* Mobiilinavigaatio valikko */}
        {mobileMenuOpen && (
          <div id="mobile-menu" className="md:hidden border-y border-white/10 bg-slate-800/40 backdrop-blur-xl">
